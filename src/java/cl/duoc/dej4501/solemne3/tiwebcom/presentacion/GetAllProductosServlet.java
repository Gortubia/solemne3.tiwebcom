 ...
 * @author adolf
 */
@WebServlet(name = "GetAllProductosServlet", urlPatterns = {"/getAllProductosServlet","getAllProductos"})
public class GetAllProductosServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Producto> listaProd = this.productoSB.getAllProductos();
        sesion.setAttribute("listaProd", listaProd);
