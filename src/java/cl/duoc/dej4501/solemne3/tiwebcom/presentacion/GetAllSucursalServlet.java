 ...
 * @author adolf
 */
@WebServlet(name = "GetAllSucursalServlet", urlPatterns = {"/getAllSucursalServlet","/cargaSucursal"})
public class GetAllSucursalServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Sucursal> listaSucursal = this.sucursalSB.getAllSucursal();
